...
export default function BoxSettings() {
  ...
  return <View className="flex-1 bg-white dark:bg-noche" style={{ paddingTop: insets.top + 6, paddingBottom: insets.bottom }}>
    <View className="flex-row items-center px-5 pb-4"><BackButton onPress={safeBack} /><Text className="ml-3 flex-1 text-lg font-extrabold text-slate-900 dark:text-slate-100">{t("boxes.manageTitle")}</Text></View>
