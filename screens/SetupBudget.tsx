...
export default function SetupBudget({ onSaved }: { onSaved: (amount: number) => void }) {
  ...
  return (
    <View className="flex-1 bg-white dark:bg-slate-900 px-6 justify-center">
      ...
      <View>
        ...
        <View className="flex-row items-center justify-center bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-800 px-4 py-5">
